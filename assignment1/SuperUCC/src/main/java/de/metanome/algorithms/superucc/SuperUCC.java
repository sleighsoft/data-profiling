...
public class SuperUCC extends SuperUCCAlgorithm // Separating the algorithm implementation and the Metanome interface implementation is good practice
	...
	return "Julian Niedermeier, Florian Wagner"; // A string listing the author(s) of this algorithm
    }

    @Override
    public String getDescription() {
	return "An Algorithm to detect Unique Coloumn Combinations"; // A string briefly describing what this algorithm does
    }
