...
public class LighthouseFD extends LighthouseFDAlgorithm
  ...
  public String getDescription() {
    return "LighthouseFD - An Algorithm to detect Unique Column Combinations"; // A string briefly describing what this algorithm does
  }
  ...
  public ArrayList<ConfigurationRequirement<?>> getConfigurationRequirements() { // Tells Metanome which and how many parameters the algorithm needs
    ...
    conf.add(new ConfigurationRequirementRelationalInput(LighthouseFD.Identifier.INPUT_GENERATOR.name()));
    return conf;
  }
  ...
  public void setRelationalInputConfigurationValue(String identifier, RelationalInputGenerator... values)
    ...
    if (!LighthouseFD.Identifier.INPUT_GENERATOR.name().equals(identifier))
